...
<aura:application >
    ...
    <link rel="stylesheet" type="text/css" href="/resource/BootstrapSF1/bootstrap320/css/bootstrap.min.css"/>
    ...
    <div class="content well">
        <c:ProgressBar barContainerClass="progress-striped active" 
                                 barClass="progress-bar-success" name="pb1" value="25"
                                 transitionDelay="10"
                                 displayText="center"
                                 usePercentage="false"
                                 valueMin="20"
    ...
    <div class="content well">
        <c:ProgressBar barContainerClass="" 
                                 barClass="progress-bar-danger" name="pb2" value="70"
                                 transitionDelay="500"
                                 displayText="fill"
                                 usePercentage="true"/>
